# -*- coding: utf-8 -*-
"""
Created on Tue Oct  5 18:08:48 2021
...
output=sys.argv[2]
param=sys.argv[3]
data=pd.read_csv(inp+'toy_dataset_train.csv',header=None)
X_test=pd.read_csv(inp+'toy_dataset_test.csv',header=None).iloc[:,1:].to_numpy()/255.
#y_test=pd.read_csv(inp+'toy_dataset_test_labels.csv',header=None)
