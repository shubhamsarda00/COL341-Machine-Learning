# -*- coding: utf-8 -*-
"""
Created on Tue Oct  5 19:34:21 2021
...
#                             np.save(output+'w_'+str(k+1)+'_.npy',temp)
                      ...
                      #  print(str(t)+': train_loss:'+ str(self.loss(y,self.fp(X))) +' test_acc:'+str(amax))
...
#                     np.save(output+'w_'+str(k+1)+'_.npy',temp)
                ...
                #print(str(t)+': train_loss:' +str(self.loss(y,self.fp(X))) +' test_acc:'+str(amax)+" val loss:" )
...
f.write('1')
f.write('\n')
f.write('[512,256,256,46]')
f.write('\n')
f.write('146')
f.close()

t=time()-th
a.fit_mom(200,150,X[:-4600],y[:-4600],X[-4600:],y[-4600:],.03,t)    